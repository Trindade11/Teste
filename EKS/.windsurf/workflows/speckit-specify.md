...
8. **Update Project Overview** (MANDATORY):

   After creating/updating a spec, update `project-context/project-overview.md`:

   a. **If file doesn't exist**: Create it from template
   
   b. **Update Status Table**:
