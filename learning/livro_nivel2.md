...
flowchart TD
    ...
    style Episodic fill:#fff4e1
    style Procedural fill:#e1f5ff
    style Evaluative fill:#f3e5f5
    style Bitemporal fill:#ffebee
```
...
- Quais fontes consultar (grafo, vector store, documentos)
...
**D2 (Profundidade Conceitual):**
```yaml
sources: [working_set, graph, vector_store]
max_hops: 3
max_tokens: 2000
